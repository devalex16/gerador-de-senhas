/*!
 Stencil Dev Server Process v2.3.0 | MIT Licensed | https://stenciljs.com
 */
'use strict';
...
const pAccess = promisify(fs__default$1['default'].access);
...
var open = async (target, options) => {
	...
	if (process.platform === 'darwin') {
		...
		if (app) {
			...
			try {
				await pAccess(localXdgOpenPath, fs__default$1['default'].constants.X_OK);
