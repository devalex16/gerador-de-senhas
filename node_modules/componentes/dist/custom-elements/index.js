import { attachShadow, createEvent, h, Host, Fragment, proxyCustomElement } from '@stencil/core/internal/client';
...
const MyCard = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
    this.buttoncard = createEvent(this, "buttoncard", 7);
  }
  render() {
    return (h(Host, null, h("div", { class: "my-card" }, h("p", { class: "title" }, this.titlecard), h("img", { class: "image", src: this.avatar }), h("p", { class: "description" }, this.description), h("a", { href: "#", class: "btn", onClick: () => this.pressedButton() }, "Go somewhere"))));
  }
  pressedButton() {
...
const MyComponent = class extends HTMLElement {
  constructor() {
    ...
    this.__registerHost();
    attachShadow(this);
    this.respuesta = createEvent(this, "respuesta", 7);
  }
  getText() {
  ...
  render() {
    return (h(Fragment, null, h("div", { id: "padre" }, h("img", { src: "https://picsum.photos/600/400" }), h("div", null, "Hello, World! I'm ", this.getText())), h("form", { class: "formTest" }, h("input", { type: "text", placeholder: "Prueba de inputs" }), h("button", { onClick: this.generateMessage }, "Enviar formulario"))));
  }
...
const MyModal = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  render() {
    return (h("div", { class: "modalContent" }, h("div", { class: "modal" }, h("h1", null, this.titlem), h("slot", null), h("div", { class: "modal-footer" }, h("button", { type: "button", class: "btn-ok", onClick: () => this.closeModal() }, "Aceptar")))));
  }
...
const MySelect = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  render() {
    ...
    if (this._objectData) {
      for (let i in this._objectData) {
        ...
        const li = h("li", Object.assign({}, props, { onClick: () => this.selection(item, i) }), h("div", { class: item.logo ? "contentImageList" : "noncontentImageList" }, h("img", { class: "imagelist", src: item.logo ? item.logo : "" })), h("div", null, item.name), h("div", { class: "separate" }));
        items.push(li);
      }
    }
    return (h(Host, null, h("link", { rel: "stylesheet", href: "https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css" }), h("div", { class: "mySelect" }, h("div", { class: "select", onClick: () => this.openDropdown() }, h("span", { class: this.placeholderimg ? "placeholderImg" : "placeholderText" }, this.placeholder), h("img", { class: this.placeholderimg ? "placeholderImg" : "placeholderText", src: this.placeholderimg ? this.placeholder : "" }), h("svg", { class: "arrow", width: "16px", height: "9px" }, h("g", { id: "Page-1", stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, h("g", { id: "CY_home_marca", transform: "translate(-649.000000, -652.000000)", fill: "#546E7A" }, h("g", { id: "Hero-Copy", transform: "translate(0.000000, 134.000000)" }, h("g", { id: "Points-Slider", transform: "translate(250.000000, 226.000000)" }, h("g", { id: "Search", transform: "translate(80.000000, 267.000000)" }, h("path", { d: "M331.033084,23.7007927 L325.453084,29.2907927 L331.033084,34.8807927 C331.420808,35.2708302 331.420808,35.9007552 331.033084,36.2907927 C330.643047,36.6785163 330.013122,36.6785163 329.623084,36.2907927 L323.263084,29.9307927 C322.912305,29.5762232 322.912305,29.0053622 323.263084,28.6507927 L329.623084,22.2907927 C330.013122,21.9030691 330.643047,21.9030691 331.033084,22.2907927 C331.420808,22.6808302 331.420808,23.3107552 331.033084,23.7007927 Z", id: "Path", transform: "translate(327.161938, 29.290793) rotate(-90.000000) translate(-327.161938, -29.290793) " })))))))), h("div", { class: "backgroundMobile", onClick: () => this.closeDropdown() }), h("div", { class: "contentList" }, h("div", { class: "contentTitle" }, h("div", { class: "title" }, this.titleselect), h("div", { class: "cancel", onClick: () => this.closeDropdown() }, this.cancelname)), h("div", { class: "firstItem" }, h("div", { class: "item", onClick: () => this.selection(this._firstItem, 0) }, h("div", { class: this._firstItem ? this._firstItem.logo :  "noncontentImageList" }, h("img", { class: "imagelist", src: this._firstItem ? this._firstItem.logo :  "" })), h("div", null, this._firstItem ? this._firstItem.name : ""), h("div", { class: "separate" }))), h("div", { class: "list" }, h("div", { class: "contentItems" }, h("ul", null, items)))))));
  }
  ...
  static get style() { return mySelectCss; }
};

const MyCard$1 = /*@__PURE__*/proxyCustomElement(MyCard, [1,"my-card",{"avatar":[1],"titlecard":[1],"description":[1]}]);
const MyComponent$1 = /*@__PURE__*/proxyCustomElement(MyComponent, [1,"my-component",{"first":[1],"middle":[1],"last":[1]}]);
const MyModal$1 = /*@__PURE__*/proxyCustomElement(MyModal, [4,"my-modal",{"titlem":[1],"isOpen":[32]},[[0,"window:keydown.escape","handleEscapeKey"]]]);
const MySelect$1 = /*@__PURE__*/proxyCustomElement(MySelect, [0,"my-select",{"titleselect":[1],"cancelname":[1],"placeholder":[1],"placeholderimg":[4],"extendlist":[2],"animationopen":[1],"animationclose":[1],"objectdata":[1],"toggle":[32],"currentItem":[32]},[[5,"mousedown","onMouseUp"],[4,"keydown","onKey"]]]);
...
export { MyCard$1 as MyCard, MyComponent$1 as MyComponent, MyModal$1 as MyModal, MySelect$1 as MySelect, defineCustomElements };
